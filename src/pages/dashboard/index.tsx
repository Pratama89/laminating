...
<section className="bg-center bg-no-repeat bg-[url('/img/latar-depan.jpeg')] bg-white bg-blend-multiply bg-cover -mt-20 " id="home">
    <div className="px-4 mx-auto mt-16 hp:mt-20 max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            ...
            <Link href="https://wa.link/nphjrf" className="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5  sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                Kontak Admin
            </Link>  
        </div>
    </div>
